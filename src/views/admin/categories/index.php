                    ...
                    <?php foreach ($categoryTree as $parent): ?>
                        <div class="category-parent mb-3">
                            <div class="d-flex align-items-center category-item p-3 bg-light rounded">
                                ...
                                <div class="btn-group">
                                    <a href="/admin/categories/edit/<?= $parent['id'] ?>" class="btn btn-sm btn-warning" title="Sửa">
                                ...
                                <div class="category-children ms-5 mt-2">
                                    <?php foreach ($parent['children'] as $child): ?>
                                        <div class="d-flex align-items-center category-item p-2 mb-2 bg-white border rounded">
                                            ...
                                            <div class="btn-group">
                                                <a href="/admin/categories/edit/<?= $child['id'] ?>" class="btn btn-sm btn-warning" title="Sửa">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <button type="button" class="btn btn-sm btn-danger" 
                                                        data-id="<?= $child['id'] ?>" 
                    ...
                    <?php else: ?>
                        <?php foreach ($categories as $category): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="/admin/categories/edit/<?= $category['id'] ?>" class="btn btn-sm btn-warning" title="Sửa">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <button type="button" class="btn btn-sm btn-danger" 
                                                data-id="<?= $category['id'] ?>" 
