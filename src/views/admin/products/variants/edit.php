            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-end">
                        <a href="/admin/inventory/adjust/<?= $variant['id'] ?>" class="btn btn-warning btn-sm">
                            <i class="fas fa-edit"></i> Điều chỉnh tồn kho
                        </a>
                        <a href="/admin/inventory/detail/<?= $variant['id'] ?>" class="btn btn-info btn-sm">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="color" name="color"
                                    value="<?= htmlspecialchars($color) ?>" placeholder="VD: Đen, Trắng, Xanh...">
                            </div>

                            <div class="col-md-4">
                                <label for="size" class="form-label">Kích thước / Size</label>
                                <input type="text" class="form-control" id="size" name="size"
                                    value="<?= htmlspecialchars($size) ?>" placeholder="VD: S, M, L, XL, 39, 40...">
                            </div>

                            <div class="col-md-4">
                                <label for="capacity" class="form-label">Dung lượng / Bộ nhớ</label>
                                <input type="text" class="form-control" id="capacity" name="capacity"
                                    value="<?= htmlspecialchars($capacity) ?>" placeholder="VD: 64GB, 128GB, 256GB...">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="custom_attr_name" name="custom_attr_name"
                                    value="<?= htmlspecialchars($customAttrName) ?>"
                                    placeholder="VD: Chất liệu, Xuất xứ...">
                            </div>

                            <div class="col-md-6">
                                <label for="custom_attr_value" class="form-label">Giá trị</label>
                                <input type="text" class="form-control" id="custom_attr_value" name="custom_attr_value"
                                    value="<?= htmlspecialchars($customAttrValue) ?>"
