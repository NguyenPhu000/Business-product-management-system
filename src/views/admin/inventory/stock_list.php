                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <div class="text-muted small text-uppercase fw-bold mb-1">Sắp hết hàng</div>
                            <div class="h4 mb-0 fw-bold"><?= count($stats['low_stock'] ?? []) ?></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <div class="rounded-circle bg-danger bg-opacity-10 p-3">
                                <i class="fas fa-box-open fa-lg text-danger"></i>
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <div class="text-muted small text-uppercase fw-bold mb-1">Hết hàng</div>
                            <div class="h4 mb-0 fw-bold"><?= count($stats['out_of_stock'] ?? []) ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <div class="text-muted small text-uppercase fw-bold mb-1">Tổng cảnh báo</div>
                            <div class="h4 mb-0 fw-bold"><?= $stats['total_alerts'] ?? 0 ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <div class="text-muted small text-uppercase fw-bold mb-1">Đang hiển thị</div>
                            <div class="h4 mb-0 fw-bold"><?= count($products ?? []) ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <table class="table table-hover table-bordered" id="stockTable">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th width="10%" class="text-center">Ngưỡng</th>
                                <th width="12%" class="text-center">Trạng thái</th>
                                <th width="13%">Cập nhật</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <a href="/admin/inventory/adjust/<?= $product['variant_id'] ?>?warehouse=<?= urlencode($product['warehouse']) ?>"
